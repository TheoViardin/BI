...
package so_emballage.remplir_datawarehouse_0_1;
...
/**
 * Job: Remplir_datawarehouse Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class Remplir_datawarehouse implements TalendJob {
	...
	private final String jobName = "Remplir_datawarehouse";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Remplir_datawarehouse.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Remplir_datawarehouse.this, new Object[] {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				so_emballage.achats_0_1.Achats childJob_tRunJob_1 = new so_emballage.achats_0_1.Achats();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				so_emballage.ventes_0_1.Ventes childJob_tRunJob_3 = new so_emballage.ventes_0_1.Ventes();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Remplir_datawarehouse Remplir_datawarehouseClass = new Remplir_datawarehouse();

		int exitCode = Remplir_datawarehouseClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Remplir_datawarehouse.class
					.getClassLoader().getResourceAsStream(
							"so_emballage/remplir_datawarehouse_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Remplir_datawarehouse.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Remplir_datawarehouse");
		}
...
/************************************************************************************************
 * 34184 characters generated by Talend Open Studio for Data Integration on the
 * 23 février 2021 15:22:14 CET
 ************************************************************************************************/
